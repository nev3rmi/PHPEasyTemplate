...
FR.initLayout = function() {
	new Ext.Viewport({
		...
		items: [
			{
				region: 'north', height: 0,
				items: FR.tempPanel
			},
			{
				region: 'west', layout: 'fit', split: true, width: 240,
				id: 'FR-Tree-Region', collapsed: FR.isMobile, stateful: false,
				items: FR.tree.panel
			},
			{
				region: 'center',
				layout: 'fit', hideBorders: true,
				items: [
					{
						layout: 'card',
						id: 'cardDisplayArea',
						activeItem: 1, hideBorders: true,
						items: [
							{
								xtype: 'tabpanel',
								id: 'gridTabPanel',
