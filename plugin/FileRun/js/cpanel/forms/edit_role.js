		...
		items: [
			{
				...
				items: [
					...
					},
					{
						...
						items: [
							{
								xtype: 'textfield', hidden: !FR.userCanSetHomeFolder,
							...
							{xtype: 'displayfield', ref: 'editPathRemark', value: FR.T('Important: Changing this path will update the home folder paths of all user accounts using this role. It will results in the automatic removal of the users\' folder sharing settings and weblinks.'), style:'padding:3px;color:red', hidden: true},
							{
								...
								name: 'create_folder', checked: parseInt(FR.roleInfo.create_folder), hidden: !FR.userCanSetHomeFolder
							},
							...
							},/*
							{
								...
								name: 'btsync', checked: parseInt(FR.roleInfo.btsync)
							},*/
							{
							...
							{xtype: 'displayfield', value: ''},
							{
								...
								allItemsText: FR.T('[All users]'), tcfg: {height: 150, width: 230},
					...
					},
					{
						...
						items: [
							...
							},
							{
								...
								name: 'traffic_quota_max', 
								value: FR.roleInfo.traffic_quota_max
							}
						]
					}
				]
