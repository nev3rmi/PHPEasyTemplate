	...
	items: {
				...
				items: [
					{
						...
						items: [
							...
							{
								xtype: 'textfield',
								fieldLabel: FR.T('Password'), value: '-no-pass-change-',
				...
				items: [
					{
						xtype: 'fieldset',
						title: FR.T('Role'),
						width: 500, hidden: (FR.userInfo.id == 1 || FR.system.isFree),
						...
						items: [
							{
								...
								listeners: {
									'beforeselect': function(f, record) {
										f.ownerCt.ownerCt.permsFieldset.setVisible((record.data.id == '-'));
					...
					},
					{
						...
						xtype: 'fieldset',
						title: FR.T('Permissions'),
						width: 500, hidden: (FR.userInfo.perms.role != '-'),
						defaults: {xtype: 'checkbox'},
						items: [
							{
								xtype: 'textfield',
								ref: 'homefolder', hidden: FR.currentUserPerms.admin_homefolder_template,
		...
		FR.T('Your personal home folder is:')+' <b>'+FR.adminHomeFolderPath+'</b><br>',
							...
							},
							{
								...
								xtype: 'panel', border: false, layout: 'hbox', hidden: (FR.currentUserPerms.admin_homefolder_template || FR.user.isIndep),
								...
								items: [
									...
									{xtype: 'button', text: FR.T('Create folder now'), cls:'fr-btn-smaller', handler: function() {
										var par = 'path='+encodeURIComponent(this.ownerCt.ownerCt.homefolder.getValue());
										var output = this.ownerCt.ownerCt.serverReply; output.show();
							...
							{
								boxLabel: FR.T('User can read file comments'), value: 1,
								name: 'perms[read_comments]', checked: parseInt(FR.userInfo.perms.read_comments)
							},
							{
								boxLabel: FR.T('User can write file comments'), value: 1,
								name: 'perms[write_comments]', checked: parseInt(FR.userInfo.perms.write_comments)
							},
							{
								boxLabel: FR.T('User can publish files as "Web Links"'),
								name: 'perms[weblink]', checked: parseInt(FR.userInfo.perms.weblink)
							},/*
							{
								boxLabel: FR.T('User can sync folders with BitTorrent Sync'),
								name: 'perms[btsync]', checked: parseInt(FR.userInfo.perms.btsync)
							},*/
							{
								boxLabel: FR.T('User can email files as attachments'), value: 1,
								name: 'perms[email]', checked: parseInt(FR.userInfo.perms.email)
							},
							{
								boxLabel: FR.T('User can share folders'), value: 1, hidden: FR.system.isFree,
							...
							{xtype: 'displayfield', value: ''},
							{
								...
								fieldLabel: FR.T('Can see and exchange files with'), showSelf: true,
							...
							},
							{
								xtype: 'fieldset',
								title: FR.T('Quotas'),
								width: 465, labelWidth: 150, hidden: FR.system.isFree,
								...
								items: [
									...
									{
										fieldLabel: FR.T('Traffic quota'),
										name: 'perms[traffic_quota_max]', 
										value: FR.userInfo.perms.traffic_quota_max
									},
									{
										fieldLabel: FR.T('This month\'s traffic'),
										name: 'perms[traffic_quota_current]',
										value: FR.userInfo.perms.traffic_quota_current
									}
								]
							}
						]
